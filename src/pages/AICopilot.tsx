    ...
    <div className="min-h-screen pt-24 pb-12 cyber-grid">
      <div className="container max-w-3xl">
        <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }}>
          ...
          <p className="text-muted-foreground text-sm mb-6">Ask questions about vulnerabilities and get AI-powered security guidance.</p>
          ...
          <div className="flex flex-wrap gap-2 mb-6">
            {suggestions.map((s) => (
              <button
                ...
                className="px-3 py-1.5 text-xs rounded-full border border-border bg-card/50 text-muted-foreground hover:border-primary/40 hover:text-primary transition-all"
              >
